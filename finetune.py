...
class FinetuneVideoPredictor:
    def __init__(self,
        ...
        self.video_prediction_trainloader = u.create_finetune_dataloader(train_folder, image_size, batch_size)
        self.video_prediction_valloader = u.create_finetune_dataloader(val_folder, image_size, batch_size)
        ...
        self.video_prediction_model = m.VideoPredictor(VICReg_model)
    ...
    def finetune(self):
        ...
        torch.save(self.video_prediction_model.state_dict(), "video_predictor_finetuned.pth")
